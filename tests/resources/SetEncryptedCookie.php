...
$cookies['cookie_2'] = EncryptedCookie::create('cookie_2',"thisismyverycomplexpassword",array('value'=>'cookie-2'))->save();

// delete a cookie (should return a CookieException when retrieved)

$cookie_3 = new EncryptedCookie('cookie_3',"thisismyverycomplexpassword");

$cookies['cookie_3'] = $cookie_3->setValue('bla')->delete();

// set a cookie expiration timestamp

$cookie_4 = new EncryptedCookie('cookie_4',"thisismyverycomplexpassword");
...
$cookie_5 = new EncryptedCookie('cookie_5',"thisismyverycomplexpassword");
